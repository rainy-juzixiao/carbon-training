  ...
  <div class="app-container">
    <el-form :model="queryParams" ref="queryForm" :inline="true" v-show="showSearch" label-width="68px">
      ...
      <el-form-item label="关键字" prop="code">
        <el-input v-model="queryParams.code" placeholder="请输入关键字" clearable  @keyup.enter.native="handleQuery" />
      </el-form-item>
      <el-form-item label="类型" prop="type">
        <el-select v-model="queryParams.type" placeholder="请选择通用查询类型" clearable filterable >
    ...
    <el-row :gutter="10" class="mb8">
      <el-col :span="1.5">
        <el-button  type="primary" plain   @click="handleAdd" v-hasPermi="['query:comQuery:add']">新增</el-button>
      </el-col>
      <el-col :span="1.5">
        <el-button  type="success" plain   :disabled="single" @click="handleUpdate" v-hasPermi="['query:comQuery:edit']">修改</el-button>
      </el-col>
      <el-col :span="1.5">
        <el-button  type="danger" plain   :disabled="multiple" @click="handleDelete" v-hasPermi="['query:comQuery:remove']">删除</el-button>
      </el-col>
      <el-col :span="1.5">
        <el-button  type="warning" plain   @click="handleExport" v-hasPermi="['query:comQuery:export']">导出</el-button>
      </el-col>
    ...
    <el-table v-loading="loading" :data="comQueryList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="关键字" align="center" prop="code"  width="200" />
      <el-table-column label="通用查询类型" align="center" prop="type" :formatter="typeFormat"  width="200" />
      <el-table-column label="操作" align="center" class-name="small-padding fixed-width" width="200" >
        <template #default="scope">
          <el-button   type="text"  @click="handleUpdate(scope.row)" v-hasPermi="['query:comQuery:edit']">修改</el-button>
          <el-button   type="text"  @click="handleDelete(scope.row)" v-hasPermi="['query:comQuery:remove']">删除</el-button>
        </template>
      </el-table-column>
    </el-table>
    ...
    <el-dialog :title="title" :model-value="open" width="500px" append-to-body>
      <el-form ref="form" :model="form" :rules="rules" label-width="100px">
        ...
        <el-form-item label="sql语句" prop="customSql">
          ...
          <el-button  type="primary"  @click="handleTest(form.customSql)">测试</el-button>
        </el-form-item>
        <el-form-item label="类型" prop="type">
