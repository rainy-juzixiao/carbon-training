  ...
  <div class="app-container">
    ...
    <el-table v-loading="loading" :data="warehouseCheckList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="操作" align="center" class-name="small-padding fixed-width" width="200">
        <template #default="scope">
          <el-button type="text" @click="handleUpdate(scope.row)" v-hasPermi="['warehouse:warehouseCheck:edit']">修改
          </el-button>
          <el-button type="text" @click="handleDelete(scope.row)" v-hasPermi="['warehouse:warehouseCheck:remove']">
            删除
          </el-button>
        </template>
      </el-table-column>
